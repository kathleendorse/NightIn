...
const recipeSeed = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      {
        id: 3,
        ing: "1 pound beef stewing meat, trimmed and cut into inch cubes",
      },
      ...
      {
        id: 11,
        ing: "2 large baking potatoes, peeled and cut into ¾-inch cubes",
      },
  ...
  },
  {
    ...
    directions: [
      {
        id: 1,
        dir: "1. Let the steak rest at room temperature for 30 minutes.",
      },
      {
        id: 2,
        dir:
  ...
  // Ingredients - Array of objects
  {
    ...
    directions: [
      {
        id: 1,
        dir: "1. Cover tederloin liberably in rub. Set in fridge overnight.",
      },
      {
        id: 2,
        dir:
      ...
      {
        id: 3,
        dir: "3. Toss potatoes in remaining oil, adding salt and pepper",
      },
      {
        id: 4,
        dir:
    ...
    ingredients: [
      {
        id: 1,
        ing:
          "3 1-inch-thick boneless pork loin chops (1 pound total), trimmed and sliced into ¼-inch-wide strips",
      },
    ...
    directions: [
      {
        id: 1,
        dir:
          "1. Grind the fennel seeds with 1 teaspoon salt and ½ teaspoon pepper in a spice grinder or chop with a knife. Transfer to a medium bowl; mix with the lemon juice and pork. Add the flour and toss to coat. In another bowl, mix the lemon zest with 2 tablespoons parsley.",
      },
      {
        id: 2,
        dir:
      ...
      },
      {
        id: 3,
        dir:
          "3. Add the mushrooms, wine and ½ cup water; scrape up any browned bits. Cover and simmer over low heat until the fennel is tender, 12 minutes. Add the pork and heat through, 2 to 3 minutes. Season with salt and pepper and top with the lemon zest-parsley mixture.",
      },
    ],
  },
  {
    ...
    directions: [
      {
        id: 1,
        dir:
          "1. Add dried rice to a medium pot and rinse with cold water until the water runs clear. Fill the pot until water covers the rice by about ¼ inch. Place over high heat and bring to a simmer.",
      },
      {
        id: 2,
        dir:
      ...
      },
      {
        id: 5,
        dir:
          "5. Add ½ to ¾ cup of cooked jasmine rice to a wide bowl. Top with ½ cup of the pork mixture, sliced cucumbers, shredded carrots, and the herb mix. Sprinkle the bowl with sweet soy sauce and sesame seeds.",
      },
    ],
  },
  // Salad
  ...
  },
  {
    ...
    directions: [
      ...
      },
      {
        id: 5,
        dir:
          "5. Stir in the Roquefort. Add sugar to taste, ½ teaspoon at a time. Whisk the dressing. Serve separately or toss in with the salad.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    directions: [
      ...
      {
        id: 3,
        dir: "3. Combine all ingredients together and toss with dressing.",
      },
      {
        id: 4,
        dir: "4. Top with toasted almonds, cilantro, and sesame seeds.",
      },
    ],
  },
  // Seafood
  {
    ...
    directions: [
      ...
      {
        id: 2,
        dir: "2. In another dish combine flour, bread crumbs and seasoning",
      },
      {
        id: 3,
        dir:
  ...
  },
  {
    ...
    ingredients: [
      {
        id: 1,
        ing: "4 (6-ounce) red snapper or other firm white fish fillets",
      },
      { id: 2, ing: "2 lemons" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      {
        id: 3,
        ing: "1 Tbsp cajun spice (provides light heat; it’s not too spicy)",
      },
      { id: 4, ing: "½ tsp salt (omit if using salted butter)" },
      { id: 5, ing: "1 Tbsp lemon juice (from ½ medium lemon)" },
      {
        id: 6,
        ing: "2 lbs uncooked large shrimp (21-25 count), peeled and deveined",
      },
  ...
  },
  {
    ...
    directions: [
      ...
      {
        id: 5,
        dir: "Garnish with fresh cilantro leaves and lime slices or wedges.",
      },
      {
        id: 6,
        dir:
  ...
  },
  {
    ...
    ingredients: [
      {
        id: 1,
        ing: "3 lbs chicken breasts (boneless, skinless), about 5-6 count",
      },
    ...
    directions: [
      {
        id: 1,
        dir: "1. Stir together all sauce ingredients in a 5-6 qt slow cooker.",
      },
      {
        id: 2,
        dir:
  ...
  },
  {
    ...
    ingredients: [
      ...
      {
        id: 2,
        ing: "1 28-ounce can whole peeled San Marzano tomatoes , with purée",
      },
      ...
      {
        id: 8,
        ing: "2 sprigs fresh basil or oregano , plus more basil for garnish",
      },
      {
        id: 9,
        ing:
  ...
  },
  {
    ...
    ingredients: [
      ...
      {
        id: 5,
        ing: "1 15-oz. can artichoke hearts, drained and roughly chopped",
      },
    ...
    directions: [
      ...
      },
      {
        id: 3,
        dir:
          "3. Add vegetables to pot along with Parmesan and ½ pasta water and, over low heat, stir vigorously to create a sauce. (Add more pasta water until you reach your desired consistency.)",
      },
  ...
  },
  {
    ...
    directions: [
      ...
      },
      {
        id: 4,
        dir:
          "4. Meanwhile, in a large skillet heat the remaining ½ tablespoon oil over medium heat. Add the sliced mushrooms. Saute until the mushrooms are soft, about 7 minutes. Add the minced garlic, next ½ teaspoon kosher salt, and oregano. Cook for another 2 minutes. Remove the pan from the heat. Add the marinara pasta sauce and stir to combine.",
      },
      {
        id: 5,
        dir:
          "5. In a large bowl add the ricotta, ¼ cup Parmesan, egg, and remaining ½ teaspoon salt and remaining ¼ teaspoon pepper. Mix well, until the mixture is evenly combined. Stir in the spinach, using a fork to break it up and distribute it as evenly with the ricotta mixture as possible.",
      },
      {
        id: 6,
        dir:
...
const wineSeed = [
  {
    ...
    type: "red",
    blurb:
      "Pinot Noir is the most romanticized red wine in the world. No other grape inspires such emotion and worship among wine enthusiasts. Festivals are thrown every year in the grape’s honor and an entire movie, Sideways, highlighted the fervor of its fans and helped boost the variety’s popularity.",
    image:
  ...
  },
  {
    ...
    image: "https://www.beveragefactory.com/images/6416-33092815151006.jpg",
    vintages: [
  ...
  },
  {
    ...
    vintages: [
      ...
      {
        id: 3,
        vin: "Bella Vineyards & Wine Caves Maple Vineyards Annie’s Block",
      },
      { id: 4, vin: "Chappellet" },
