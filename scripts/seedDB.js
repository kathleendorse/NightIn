...
const nightSeed = [
  // Beef
  {
    ...
    directions: [
      {id: 1, ing: "About 20 minutes before grilling, remove the steaks from the refrigerator and cover in olive oil and garlic salt and pepper. Let sit, covered, at room temperature."},
      {id: 2, ing: "Prepare rice using desired method and allow it to cook while you prepare steak and broccoli."},
      ...
      {id: 4, ing: "Transfer the steaks to a cutting board or platter, tent loosely with foil and let rest 5 minutes before slicing. Add rice and broccoli."},
      {id: 5, ing: "Add the drained black beans and bring to a boil. Reduce heat, cover, and simmer for 30-50 minutes (depending on rice variety). Stir the mixture occasionally and add more liquid as needed to keep it from sticking to the bottom."},
      {id: 6, ing: "About 10 minutes before the rice is done, sear the skirt steak. Pat the steak dry and season all over with salt and pepper."},
      {id: 7, ing: "Heat the neutral cooking oil in a skillet over high heat. Once the oil is very, very hot add the steak and cook without moving for 3-5 minutes (depending on thickness). Flip and cook until desired internal temperature is reached, about 3-4 minutes more. Transfer to a plate and cover with foil."},
      {id: 8, ing: "Divide the spicy rice and beans between plates and arrange the steak on top. Pile each plate with the garnish and enjoy!"}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "In a wide pot, heat the oil over medium-high. Once hot, add the onion and jalapeño pepper and cook, stirring often, for 7-8 minutes until golden brown."},
      {id: 2, ing: "Add the mushrooms to the skillet and cook, stirring occasionally, for 8-10 minutes until well-browned all over. Season with salt and pepper."},
      {id: 3, ing: "Pour the tequila into the skillet and scrape up any browned bits stuck to the bottom of the pan. Bring to a boil and cook until most of the liquid has evaporated."},
      {id: 4, ing: "Add the rice to the vegetables and season with the spices. Add the bay leaves. Pour in the chicken stock and scrape up any browned bits stuck to the bottom."}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "Combine the flour and pepper in a bowl, add the beef and toss to coat well. Heat 3 teaspoons of the oil in a large pot. Add the beef a few pieces at a time; do not overcrowd. Cook, turning the pieces until beef is browned on all sides, about 5 minutes per batch; add more oil as needed between batches."},
      {id: 2, ing: "Remove the beef from the pot and add the vinegar and wine. Cook over medium-high heat, scraping the pan with a wooden spoon to loosen any browned bits. Add the beef, beef broth and bay leaves. Bring to a boil, then reduce to a slow simmer."},
  ...
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Pat medallions dry. Heat oil in pan over medium heat. Sear medallions, browning for 2 minutes on each side to develop a dark mahogany crust; remove from pan"},
      {id: 2, ing: "2. Add pearl onions and sear until golden. Add red wine; reduce by half. Add beef stock, tomato paste, salt, pepper and thyme. Simmer 2 minutes until sauce has thickened."},
      {id: 3, ing: "3. Add medallions, cover and turn off heat. Allow to sit covered for five minutes before serving."}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Let the steak rest at room temperature for 30 minutes."},
      {id: 2, ing: "2. Preheat the broiler. Heat a cast-iron skillet over medium-high heat until very hot."},
      ...
      {id: 4, ing: "4. Broil to desired doneness, about 4 minutes for medium rare, 5 to 6 minutes for medium.  Transfer to a serving plate and pour the pan drippings over the steak."}
    ],
  },
  // Pork 
  // Ingredients - Array of objects
  {
    ...
    directions: [
      {id: 1, ing: "1. Cover tederloin liberably in rub. Set in fridge overnight."},
      {id: 2, ing: "2. Pre-Heat oven to 425. Tie twine around tenderloin in criss-crossed pattern. Cover with 1 Tablespoon of olive oil and place on cooking sheet, uncovered."},
      {id: 3, ing: "3. Toss potatoes in remaining oil, adding salt and pepper"},
      {id: 4, ing: "Pour potatoes out onto the baking sheet, srrounding the tenderloin and place in the oven."},
      {id: 5, ing: "5. Roast for 25 minutes, turning the tenderloin over every 6-8 minutes."}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Preheat oven broiler (or grill) on medium-high heat. Season chops with salt, pepper and garlic powder just before cooking."},
      {id: 2, ing: "2. Heat oil in a pan or skillet over medium high heat until hot. Sear chops on both sides until golden and cooked through (about 4-5 minutes each side). Transfer to a plate; set aside."},
      ...
      {id: 4, ing: "4. Add pork back into the pan, baste generously with the sauce and broil/grill for 1-2 minutes, or until edges are slightly charred."},
      {id: 5, ing: "5. Garnish with parsley and serve over vegetables, rice, pasta or with a salad."}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Grind the fennel seeds with 1 teaspoon salt and 1/2 teaspoon pepper in a spice grinder or chop with a knife. Transfer to a medium bowl; mix with the lemon juice and pork. Add the flour and toss to coat. In another bowl, mix the lemon zest with 2 tablespoons parsley."},
      {id: 2, ing: "2. Heat a deep skillet or pot over high heat and add the olive oil. Brown the pork in batches, 1 minute per side; transfer to a plate. Add the shallots, fennel bulb, the remaining 3 tablespoons parsley, and salt to taste to the skillet. Reduce the heat and cook until the vegetables are wilted, 2 minutes. Add the tomato paste and cook, stirring, 3 minutes."},
      {id: 3, ing: "3. Add the mushrooms, wine and 1/2 cup water; scrape up any browned bits. Cover and simmer over low heat until the fennel is tender, 12 minutes. Add the pork and heat through, 2 to 3 minutes. Season with salt and pepper and top with the lemon zest-parsley mixture."}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Preheat oven to 160°C/320°F (all oven types). Combine the Rub ingredients and rub onto both sides of the ribs (most on meaty side). Set aside to marinate for 20 minutes (or overnight). Place ribs on a tray in a single layer. Pour apple cider underneath the ribs, cover with foil then bake for 1 hour 30 minutes or until the meat is pretty tender (Note 5)"},
      {id: 2, ing: "2. Remove from oven, turn up to 180°C/350°F. Remove foil, drizzle with olive oil, then return ribs to oven for 15 minutes or until rub becomes nice and crusty. Line a new tray with foil then baking / parchment paper. Remove ribs from oven, transfer to lined tray. Pour any juices from tray over the ribs."},
      {id: 3, ing: "3. Flip ribs so the bonier side is up. Slather with Barbecue Sauce, then bake 10 minutes. Remove from oven, then turn ribs over so the meaty side is up. Slather with Barbecue Sauce, bake 5 minutes. Repeat 2 or 3 more times until you've got a thick glaze on the ribs. "},
      {id: 4, ing: "4. Cut ribs into individual or multiple rib portions and serve with remaining Barbcue Sauce!"}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Add dried rice to a medium pot and rinse with cold water until the water runs clear. Fill the pot until water covers the rice by about 1/4 inch. Place over high heat and bring to a simmer."},
      {id: 2, ing: "2. Once simmering, stir the rice, cover it, and turn heat down to very low. Simmer rice slowly for 8 to 10 minutes, then test rice. If it’s cooked through (i.e. not crunchy), drain off any extra water, remove from heat, cover and steam for five minutes, then fluff with a fork."},
      {id: 3, ing: "3. In a large skillet over medium-high heat, add the olive oil and diced onions. Cook until the onions turn translucent, 3 to 4 minutes. Add ground pork and break up with a spatula continuously while cooking until the pork is crumbly, browned, and cooked through, 7 to 8 minutes."},
      {id: 4, ing: "4. When the pork is almost done cooking, add garlic, ginger, and soy sauce. Stir, and cook for another minute or two to combine flavors."},
      {id: 5, ing: "5. Add 1/2 to 3/4 cup of cooked jasmine rice to a wide bowl. Top with 1/2 cup of the pork mixture, sliced cucumbers, shredded carrots, and the herb mix. Sprinkle the bowl with sweet soy sauce and sesame seeds."}
    ],
  },
  // Salad
  {
    ...
    directions: [
      {id: 1, ing: "1. Chop together anchovy fillets, garlic, and pinch of salt. Use the side of a knife blade to mash into a paste, then scrape into a medium bowl. Whisk in egg yolks, 2 Tbsp. lemon juice, and mustard. Adding drop by drop to start, gradually whisk in olive oil, then vegetable oil; whisk until dressing is thick and glossy. Whisk in Parmesan. Season with salt, pepper, and more lemon juice, if desired."},
      {id: 2, ing: "2. Prepare lettuce. Use whole leaves; they provide the ideal mix of crispness, surface area, and structure."},
      {id: 3, ing: "3. Caesars crowned with a mound of grated Parmesan may look impressive, but all that clumpy cheese mutes the dressing. Instead, use a vegetable peeler to thinly shave a modest amount on top for little salty bursts."},
      {id: 4, ing: "4. Use your hands to gently toss the lettuce, croutons, and dressing, then top off with the shaved Parm."}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Cook the bacon in a skillet on medium heat until crisp on both sides. Remove from skillet and lay out on paper towels to absorb the excess fat. Allow the bacon to cool. Crumble the bacon and set aside."},
      {id: 2, ing: "2. Toss the various lettuces: In a large salad bowl, toss together well the various lettuces and watercress."},
      {id: 3, ing: "3. Compose the salad: Arrange the chicken, the bacon, the tomato, and the avocado decoratively over the greens and garnish the salad with the chopped egg and the chives."},
      {id: 4, ing: "4. Make the vinaigrette: In a small bowl whisk together the vinegar, the mustard, and salt and pepper to taste, add the oil in a slow stream, whisking, and whisk the dressing until it is emulsified."},
      {id: 5, ing: "5. Stir in the Roquefort. Add sugar to taste, 1/2 teaspoon at a time. Whisk the dressing. Serve separately or toss in with the salad."}
    ],
  },
  {
    name: "Winter Salad",
    ...
    directions: [
      {id: 1, ing: "1. In a small bowl, mix mayo, syrup, vinegar, shallots and sugar; gradually whisk in oil until blended. Refrigerate, covered, until serving."},
      {id: 2, ing: "2. To serve, place remaining ingredients in a large bowl; toss with dressing."}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Make the Glazed Walnuts or Glazed Pecans. (While they cook, prep the rest of the salad. Or, you can make these ahead!)"},
      {id: 2, ing: "2. Make the Best Balsamic Dressing."},
      {id: 3, ing: "3. Core the apple and pear, cut them into thin slices."},
      {id: 4, ing: "4. Place the greens on serving plates and top with apples, pears, and walnuts. Pour over the dressing and serve. (Pro tip: Dress it up by adding cubed Manchego cheese!)"}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Wash, prep and chop all vegetables"},
      {id: 2, ing: "2. Heat sesame oil in a skillet over medium heat and toast almonds for 3-5 minutes or until slightly browned and fragrant. Set aside to cool."},
      {id: 3, ing: "3. Combine all ingredients together and toss with dressing."},
      {id: 4, ing: "4. Top with toasted almonds, cilantro, and sesame seeds."}
    ],
  },
  // Seafood
  {
    ...
    directions: [
      {id: 1, ing: "1. Lightly beat eggs in a dish"},
      {id: 2, ing: "2. In another dish combine flour, bread crumbs and seasoning"},
      {id: 3, ing: "3. Dip fish in egg and then in flour mixture. Shake off any excess flour."},
      {id: 4, ing: "4. Add a couple of tablespoons of oil to a pan and heat pan over medium heat."},
      {id: 5, ing: "5. When pan is hot, add 3-4 fillets to pan. Cook 3 minutes per side so each side is nicely browned. "},
      {id: 6, ing: "6. Remove fish from pan and place on a baking sheet lined with a baking rack. Place cooked fish in a 350 degree oven while you cook remaining fish. "},
      {id: 7, ing: "7. Wipe out pan and add additional oil. Repeat process with remaining fish. "},
      {id: 8, ing: ""}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Heat oven to 400°F | 200°C. On a large rimmed baking sheet, toss together potatoes with the oil, 1/2 tablespoon of garlic, 1/2 teaspoon salt, and 1/4 teaspoon pepper. Spread out in an even layer and roast for 15 minutes until they're just starting to soften and brown."},
      {id: 2, ing: "2. Push potatoes to one side of the sheet pan and arrange salmon down the centre. Rub salmon evenly with 1 1/2 tablespoons of the minced garlic and 2 tablespoons of parsley. Add the asparagus to the other side of the pan. "},
      {id: 3, ing: "3. Combine 1/4 cup of lemon juice and 1/4 cup of the melted butter together and pour the mixture over the salmon and asparagus. Season everything with the remaining salt and pepper."},
      {id: 4, ing: "4. Return to oven and continue baking until the potatoes are golden and fork-tender and the salmon is opaque throughout, (about 10 minutes). Optional: broil in the last 2 minutes for charred edges.   "},
      {id: 5, ing: "5. Meanwhile, in a small bowl, combine the remaining butter, garlic and lemon juice with the wine (or chicken stock). Serve with the salmon, veggies and lemon slices!"}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Preheat oven to 425. Cut 1 lemon into 8 slices. Place slices, in pairs, on a rimmed baking sheet coated with cooking spray. Grate remaining lemon to get 1 teaspoon lemon rind; set aside. Reserve lemon for another use."},
      {id: 2, ing: "2. Place 1 fillet on top of each pair of lemon slices. Combine salt, paprika, and pepper; sprinkle evenly over fish. Bake at 425° for 13 minutes or until fish flakes easily when tested with a fork or until desired degree of doneness."},
      {id: 3, ing: "3. While fish bakes, combine reserved lemon rind, butter, and herbs in a small bowl."},
      {id: 4, ing: "4. Place fish and lemon slices on individual serving plates; top each fillet with herbed butter, spreading to melt, if desired. Garnish with herb sprigs, if desired."}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Soak wooden skewers in water 30 min (reduces burning of the sticks). Preheat Grill to med/high (400˚F)."},
      {id: 2, ing: "2. Combine all marinade ingredients in a small sauce pan. Bring to a simmer then remove from heat. Pour half of the mixture into a ramekin and leave remaining marinade in pan (You’ll brush on half now and brush on remaining marinade after shrimp are grilled)."},
      {id: 3, ing: "3. Skewer 4 shrimp on each damp skewer without leaving spaces. Lay skewers flat on a rimmed Cookie Sheet. Brush one side of the skewered shrimp with sauce and refrigerate for 2 min until butter firms up. Flip shrimp over, brush second side and refrigerate 2 min until butter firms up."},
      {id: 4, ing: "4. Place skewers on the barbie and grill shrimp with the lid on about 2 minutes per side or just until cooked through and no longer transparent. Remove shrimp from grill. Don’t overcook or they will be rubbery. Brush on reserved sauce and serve."}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Rinse tilapia fillets in cold water and pat dry with paper towels. Season both sides of each fillet with salt and pepper. Place the flour in a shallow dish; gently press each fillet into the flour to coat and shake off the excess flour."},
      {id: 2, ing: "2. Heat the olive oil in a skillet over medium-high heat; cook the tilapia in the hot oil until the fish flakes easily with a fork, about 4 minutes per side. Brush the melted butter onto the tilapia in the last minute before removing from the skillet. Serve immediately."}
    ],
  },
  // Chicken
  {
    ...
    directions: [
      {id: 1, ing: "1. In a skillet, saute onion and 2 cloves minced garlic in a tablespoon olive oil for 3 – 4 minutes, until fragrant and translucent. Add tomato and chicken stock, bring to a boil and simmer over low-medium heat until the sauce reduces and starts to thicken, about 15 – 20 minutes. Stir in sugar and balsamic, adjust seasoning with salt and pepper, then set aside in a large bowl."},
      {id: 2, ing: "2. In the mean time: In another skillet or frying pan, add olive oil and garlic, sauté over medium heat for 1-2 minutes. Add spinach and stir frequently until wilted and cooked, about 2-3 minutes. Set garlic and spinach aside."},
      ...
      {id: 4, ing: "4. Heat a skillet over medium heat with a tablespoon olive oil. Sear and cook chicken on both sides for 5 minutes each, until golden and cooked through. Cheese should be melted and bubbly. Pour the tomato sauce around chicken to reheat quickly until simmering. Serve immediately, enjoy!"},
      {id: 5, ing: ""}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Preheat an oven to 425°F."},
      {id: 2, ing: "2. Place flour in shallow dish. Place the eggs in a second dish (and beat with a fork)."},
      {id: 3, ing: "3. Combine Panko, Italian crumbs, grated parmesan, 2 tablespoons fresh parsley, salt and pepper to taste in a third shallow dish."},
      {id: 4, ing: "4. Pound chicken breasts to ½ inch thick (if they're very large you can cut them in half)."},
      {id: 5, ing: "5. Dip chicken into flour and shake to remove any excess. Dip chicken in beaten eggs & then into bread crumb mixture (press to adhere)."},
      {id: 6, ing: "6. Preheat oil in a large pan. Brown chicken on each side, about 4 minutes per side or until golden (it does not need to cook through as it will continue to cook in the oven)."},
      {id: 7, ing: "7. Place 1 ½ cups of marinara sauce in the bottom of a 9x13 dish. Add browned chicken. Top each piece with a couple tablespoons of marinara sauce, mozzarella and parmesan."},
      {id: 8, ing: "8. Bake 20-25 minutes or until golden and bubbly and chicken reaches 165°F. Sprinkle with fresh herbs and serve over pasta."}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Preheat oven to 350 degrees F (175 degrees C). Lightly grease a baking sheet. Heat a cast iron skillet over high heat for 5 minutes until it is smoking hot."},
      {id: 2, ing: "2. Mix together the paprika, salt, cayenne, cumin, thyme, white pepper, and onion powder. Oil the chicken breasts with cooking spray on both sides, then coat the chicken breasts evenly with the spice mixture."},
      {id: 3, ing: "3. Place the chicken in the hot pan, and cook for 1 minute. Turn, and cook 1 minute on other side. Place the breasts on the prepared baking sheet."},
      {id: 4, ing: "4. Bake in the preheated oven until no longer pink in the center and the juices run clear, about 5 minutes."}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Preheat oven to 425°F (220°C)."},
      {id: 2, ing: "2. In a medium-sized shallow bowl, whisk together 2 tablespoons olive oil together with the lime juice, chopped cilantro, chili flakes, garlic, sugar and cumin. Add the chicken thighs to the marinade and toss to evenly coat. Cover and refrigerate thighs for 15 minutes."},
      {id: 3, ing: "3. Heat the remaining one tablespoon of oil in a non stick pan or cast iron skillet over medium-high heat. Add in the thighs along with any marinade left over in the bowl, and sear chicken -- skin-side down -- for 4 minutes on each side until golden and crispy (chicken will not be fully cooked)."},
      {id: 4, ing: "4. Transfer to preheated oven and bake until the chicken is cooked through (about 15-20 minutes)."},
      {id: 5, ing: "Garnish with fresh cilantro leaves and lime slices or wedges."},
      {id: 6, ing: "Serve over steamed rice or cauliflower rice, and drizzle with the pan juices."},
      {id: 7, ing: ""},
      {id: 8, ing: ""}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Stir together all sauce ingredients in a 5-6 qt slow cooker."},
      {id: 2, ing: "2. Add chicken and turn to coat. Cover and cook on high 3 to 4 hours or on low for 6-7 hours. Chicken is done when cooked through and easy to shred."},
      {id: 3, ing: "3. Remove chicken to a cutting board and shred each breast using two forks. Place shredded chicken back in the crock pot and stir to coat with the yummy sauce."}
    ],
  },
  // Pasta
  {
    ...
    directions: [
      {id: 1, ing: "1. In a large pot, heat water over high heat until boiling. Add salt to season the water. Once it is boiling, add fettuccine and cook according to package instructions."},
      {id: 2, ing: "2. In a large skillet or pan, heat butter over medium heat. Add minced garlic and cook for 1 to 2 minutes. Stir in heavy cream. "},
      {id: 3, ing: "3. Let heavy cream reduce and cook for 5 to 8 minutes. Add half of the parmesan cheese to the mixture and whisk well until smooth. Keep over heat and whisk well until cheese is melted."},
      {id: 4, ing: "4. Save some pasta water. The pasta water is full of flavor and can be used to thin out the sauce."},
      {id: 5, ing: "5. Toss alfredo sauce with fettuccine pasta and add half of the parmesan cheese. Once it is tossed, garnish with the remaining parmesan cheese. Add a little pasta water if it needs to be thinned out."},
      {id: 6, ing: "6. Garnish with Italian parsley, if so desired."}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. In a large bowl combine pasta, sundried tomatoes, bell pepper, olives, spinach, basil, and parmesan cheese. Toss until combined."},
      {id: 2, ing: "2. To make the dressing: In a small bowl whisk olive oil, vinegar, water, salt, sugar, oregano, basil, garlic and salt and pepper."},
      {id: 3, ing: "3. Drizzle the dressing over the pasta salad and serve."}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Bring a large pot of water to a boil and season generously with kosher salt."},
      {id: 2, ing: "2. Meanwhile, begin preparing the marinara. Pour the tomatoes and purée into a bowl and crush with your hands or the the back of a spoon, then set aside."},
      {id: 3, ing: "3. In a large cold skillet, add the extra-virgin olive oil and garlic cloves, and bring to medium heat. As the garlic begins to sizzle, stir occasionally, and cook until fragrant and golden, about 5 minutes. Monitor the heat so the garlic doesn't cook too quickly or burn."},
      {id: 4, ing: "4. Very carefully stir the tomato paste into the garlic and oil—take care so the oil doesn't splatter and burn you as the paste is added—and cook for 1-2 minutes. Carefully spoon the tomatoes into the pan with the oil and paste and season with salt and pepper. Add the basil sprigs and bring to a boil. Reduce to a bubbling simmer over low heat, stirring occasionally, for 30 minutes. Stir to mix the oil that rises to the top, then discard the basil sprigs and garlic."}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Preheat oven to 400°. In a large pot of salted boiling water, cook pasta until al dente. Drain, reserving 1 cup pasta water, and return to pot."},
      {id: 2, ing: "2. On a large baking sheet, toss broccoli, tomatoes, mushrooms, and artichoke hearts with oil and season with garlic powder, salt, and pepper. Roast until tender and caramelized, stirring once, 15 to 20 minutes."},
      {id: 3, ing: "3. Add vegetables to pot along with Parmesan and 1/2 pasta water and, over low heat, stir vigorously to create a sauce. (Add more pasta water until you reach your desired consistency.)"},
      {id: 4, ing: "4. Garnish with Parmesan and basil before serving."}
    ],
  },
  {
    ...
    directions: [
      {id: 1, ing: "1. Position racks in the upper and lower thirds of your oven. Preheat the oven to 400 degrees F. Lightly coat 2 rimmed baking sheets with nonstick spray. Coat a 9x13-inch baking dish with nonstick spray and set aside."},
...
const wineSeed = [
  {
    ...
    vintages:  [
      {id: 1, ing: "Belle Glos Clark & Telephone Vineyard Pinot Noir"},
      {id: 2, ing: "La Crema Willamette Valley Pinot Noir 2018"},
      {id: 3, ing: "Kosta Browne Sta. Rita Hills Pinot Noir"},
      {id: 4, ing: "Samuel Robert Family Reserve"},
      {id: 5, ing: "Vennstone Tri Appellation"}
    ],
  },
  {
    name: "Merlot",
    ...
    vintages: [
      ...
      {id: 3, ing: "Duckhorn Vineyards"},
      {id: 4, ing: "Wildhaven Columbia Valley"},
      {id: 5, ing: "Barnett Spring Mountain"}
    ],
  },
  {
    ...
    vintages: [
      ...
      {id: 3, ing: "Gunlach-Bundschu Estate Vineyard"},
      {id: 4, ing: "Cabernario No. 8"},
      {id: 5, ing: "Mascota Vineyards Unanime"}
    ],
  },
  {
    name: "Syrah",
    ...
    vintages: [
      ...
      {id: 2, ing: "J Lohr"},
      {id: 3, ing: "Chopo Jumilla Monastrell"},
      {id: 4, ing: "Sobon Estate"},
      {id: 5, ing: "Coppola Diamond"}
    ],
  },
  {
    name: "Malbec",
    ...
    vintages: [
      ...
      {id: 3, ing: "Crios de Susana Balbo"},
      {id: 4, ing: "Luca Uco Valley"},
      {id: 5, ing: "Atrium Cahors"}
    ],
  },
  {
    ...
    vintages: [
      ...
      {id: 3, ing: "Margerum 2018 Sybarite"},
      {id: 4, ing: "Domaine Anthony & David Girard 2018 Les Montes Damnés"},
      {id: 5, ing: "Nobilo 2018 Icon"}
    ],
  },
  {
    name: "Pinot Gris",
    ...
    vintages: [
      {id: 1, ing: "Fern Ridge"},
      {id: 2, ing: "Chateau"},
      {id: 3, ing: "Chateau Ste Michelle"},
      {id: 4, ing: "Willamette Valley"},
      {id: 5, ing: "Coelho Renovacao"}
    ],
  },
  {
    name: "Chardonnay",
    ...
    vintages: [
      ...
      {id: 3, ing: "Bravium Russian River Valley"},
      {id: 4, ing: "Talley Vineyeards"},
      {id: 5, ing: "Balletto Teresa's Unoaked"}
    ],
  },
  {
    name: "Zinfandel",
    ...
    vintages: [
      ...
      {id: 3, ing: "Bella Vineyards & Wine Caves Maple Vineyards Annie’s Block"},
      {id: 4, ing: "Chappellet"},
      {id: 5, ing: "Cline Ancient Vines"}
    ],
  },
  {
    name: "Rose",
    ...
    vintages: [
      ...
      {id: 3, ing: "Domaine Piegonne Ventoux"},
      {id: 4, ing: "La Galiniere Ste Victoire "},
      {id: 5, ing: "Tendance Caladoc"}
    ],
  },
  {
    name: "Reisling",
    ...
    vintages: [
      ...
      {id: 3, ing: "Smaragd Klaus Prager Wachau"},
      {id: 4, ing: "Ravines Finger Lakes"},
      {id: 5, ing: "Brand Grand Cru Albert Boxler Alsace"}
    ],
  },
];
